...
type TimeClient interface {
	GetCurrentTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeReply, error)
}
...
func (c *timeClient) GetCurrentTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeReply, error) {
	out := new(TimeReply)
	err := c.cc.Invoke(ctx, "/Time/GetCurrentTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServer interface {
	GetCurrentTime(context.Context, *TimeRequest) (*TimeReply, error)
...
func (UnimplementedTimeServer) GetCurrentTime(context.Context, *TimeRequest) (*TimeReply, error) {
...
func _Time_GetCurrentTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Time/GetCurrentTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServer).GetCurrentTime(ctx, req.(*TimeRequest))
	}
